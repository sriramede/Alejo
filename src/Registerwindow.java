	...
	public Registerwindow() {
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<User> validationinreg=loginobjinreg.userlist;
					
				for(int i=0;i<=validationinreg.size();i++) {
					
					if(validationinreg.get(i).getId()==Integer.parseInt(id)) {
						try {
							JOptionPane.showMessageDialog(null, "this id already exits");
						} catch (NullPointerException e1) {
							// TODO Auto-generated catch block
							JOptionPane.showMessageDialog(null, "this id already exits as null");
							e1.printStackTrace();
						}
					}
					else {
						...
						try {
							loginobjinreg.createuser1(Integer.parseInt(id), name, username, password);
							...
							// TODO Auto-generated catch block
							e2.printStackTrace();
							JOptionPane.showMessageDialog(null, "You are registered null values over here");
						}
					}
